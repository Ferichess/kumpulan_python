...
def youtube_login(email, password):
    ...
    driver.get(
        "https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Fwww.youtube.com%2Fsignin%3Faction_handle_signin%3Dtrue%26app%3Ddesktop%26hl%3Did%26next%3Dhttps%253A%252F%252Fwww.youtube.com%252F&ec=65620&hl=id&ifkv=ARpgrqdmzp0IEQ6kJmAfWOVkpakLJHETW0ow6K18azJn_iwBaBh_K6DOQBrNy5IRUsdnqR05YT3BPQ&passive=true&service=youtube&uilel=3&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S-30493220%3A1726909142752579&ddm=0"
    )
    ...
    find_pass_field = (By.XPATH, "//input[@name='password']")
...
def comment_page(driver, urls, comment):
    ...
    if not check_exists_by_xpath(
        driver, '//*[@id="simple-box"]/ytd-comment-simplebox-renderer'
    ):
        print("skiped")
        return comment_page(driver, urls, random_comment())
...
if __name__ == "__main__":
    ...
    while True:
        ...
        driver.find_element(
            By.CSS_SELECTOR, "#container > ytd-toggle-button-renderer > a"
        ).click()
        time.sleep(3)
        ...
        driver.find_element(
            By.XPATH,
            "(//yt-formatted-string[@class='style-scope ytd-search-filter-renderer'])[1]",
        ).click()
        time.sleep(3)
